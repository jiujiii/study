package com.se.java8.lambda_experssion;
...
public class LambdaExpression {
    ...
    public void demo2() {
        ...
        apples.add(new Apple("red", 250D));
        apples.add(new Apple("blue", 100D));
        List<Apple> heavyAppleStream = apples.stream().filter((Apple a) -> a.getWeight() >= 150).collect(Collectors.toList());
        List<Apple> heavyAppleParallelStream = apples.parallelStream().filter((Apple a) -> a.getWeight() >= 100).collect(Collectors.toList());
        System.out.println(heavyAppleStream);
        System.out.println(heavyAppleParallelStream);
        System.out.println(filterGreenApple(apples));
        System.out.println(filterfilterApple(apples, (Apple a) -> "blue" .equals(a.getColor())));
    }
    ...
    public void demo7(){
        ...
        apples.add(new Apple("blue",200D));
        apples.add(new Apple("yellow",150D));
        apples.add(new Apple("red",150D));
        apples.add(new Apple("yellow",250D));
        apples.add(new Apple("red",150D));
        apples.add(new Apple("blue",250D));
        apples.add(new Apple("red",150D));
        apples.add(new Apple("blue",100D));
        apples.add(new Apple("red",300D));
        apples.add(new Apple("yellow",200D));
        apples.add(new Apple("blue",300D));
        apples.add(new Apple("blue",100D));
        apples.add(new Apple("red",500D));
        ...
        System.out.println(filterfilterApple(apples, apple150Filter.and(appleRedFilter)));
        System.out.println(filterfilterApple(apples, apple150Filter.or(appleRedFilter)));
        System.out.println(filterfilterApple(apples, apple150Filter.and(appleRedFilter).negate()));
    }
    ...
    private List<Apple> filterfilterApple(List<Apple> inventory, Predicate<Apple> p) {
        ArrayList<Apple> apples = new ArrayList<>();
    ...
    private static String processFile(BufferedReaderProcessor brp) throws IOException {
        InputStream resourceAsStream = LambdaExpression.class.getClassLoader().getResourceAsStream("mongo.properties");
